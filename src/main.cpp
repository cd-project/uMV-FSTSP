...
int main(int argc, char**argv) {
    ...
    if (argc == 2) {
        ...
        folder_path ="/home/cuong/CLionProjects/uMV-FSTSP/Murray_Chu_2015_test_data/FSTSP/FSTSP_10_customer_problems/20140810T123437v2";
    }
    ...
    if (write) {
        ...
        std::ofstream out("/home/cuong/CLionProjects/uMV-FSTSP/og_murray.csv", std::ios::app);
        if(!out.is_open()) {
